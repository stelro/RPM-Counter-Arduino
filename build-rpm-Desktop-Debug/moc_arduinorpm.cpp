...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ArduinoRpm_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ArduinoRpm_t qt_meta_stringdata_ArduinoRpm = {
    {
QT_MOC_LITERAL(0, 0, 10), // "ArduinoRpm"
QT_MOC_LITERAL(1, 11, 13), // "serialReciver"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 17), // "SerialInitializer"
QT_MOC_LITERAL(4, 44, 9) // "showFrame"

    },
    "ArduinoRpm\0serialReciver\0\0SerialInitializer\0"
    "showFrame"
};
...
void ArduinoRpm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->serialReciver(); break;
        case 1: _t->SerialInitializer(); break;
        case 2: _t->showFrame(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
void *ArduinoRpm::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ArduinoRpm.stringdata0))
